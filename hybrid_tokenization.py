...
if __name__ == '__main__':
    ...
    tokenizer_japanese = FullTokenizerForMecab(sub_tokenizer=sub_tokenizer,
                                      vocab_file=vocab_file_jap,
                                      do_lower_case=False)
    
    # FullTokenizer for English
    tokenizer_english = tokenization.FullTokenizer(vocab_file=vocab_file_eng, do_lower_case=False)
    ...
    print ('Initial text', original_text)
    print()
