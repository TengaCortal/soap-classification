...
import soap_classification.prediction.soap_preprocessing as sp
import train_tfidf as tt
from train_tfidf import tokenize
...
if __name__ == "__main__":
    ...
    partitioned_soaps = partitioned_soaps[0].apply(tt.get_words)

    print(partitioned_soaps)
    classifier = get_classifier()
    predicted_labels = predict_labels(classifier, partitioned_soaps)
